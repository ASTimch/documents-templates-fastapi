...
from app.api.v2.auth import view_router as auth_view_router
from app.api.v2.document import view_router as document_view_router
from app.api.v2.template import view_router as template_view_router
...
v2.include_router(template_view_router, prefix="/template", tags=["Шаблоны"])
v2.include_router(auth_view_router, prefix="/auth", tags=["Авторизация"])
